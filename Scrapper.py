...
class ImageScrapperClass:
    ...
    def __init__(self, no_images):
        ...
        try:
            ...
            logger_ins.print_log('(Scrapper.py(__init__) - Something went wrong ' + str(e), 'exception')
            raise Exception(e)
    ...
    def get_request(self, search_query):
       ...
       # This function will open the chrome browser for fetching operations
        ...
        try:
            ...
            logger_ins.print_log('(Scrapper.py(get_request) - Something went wrong ' + str(e), 'exception')
            raise Exception(e)
        ...
        try:
            ...
            for img in thumbnail_images[current_count: no_thumbnail_images]:
                ...
                try:
                    ...
                    logger_ins.print_log('(Scrapper.py(store_url)) - Something went wrong ' + str(e), 'info')
                    continue
            ...
            logger_ins.print_log('(Scrapper.py(store_url) - Something went wrong ' + str(e), 'exception')
            raise Exception(e)
    ...
    def fetch_thumbnails(self, req_id, email, cassandra):
       ...
       # This function will fetch the thumbnails of images from the Chrome
        ...
        try:
            ...
            logger_ins.print_log('Images URL has been downloaded', 'info')
            ...
            logger_ins.print_log('(Scrapper.py(fetch_thumbnails) - Something went wrong ' + str(e), 'exception')
            raise Exception(e)
    ...
    def scroll_to_end(self):
       ...
       # This function scrolls the browser window to the end of the document body
        ...
        try:
            ...
            logger_ins.print_log('(Scrapper.py(scroll_to_end) - Something went wrong ' + str(e), 'exception')
            raise Exception(e)
    ...
    def close_browser(self):
       ...
       # This function closes the browser object
        ...
        try:
            ...
            logger_ins.print_log('(Scrapper.py(close_browser) - Something went wrong ' + str(e), 'exception')
            raise Exception(e)
